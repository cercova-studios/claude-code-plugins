...
```bash
# Read main file
cat ${AGENT_ROOT}/skills/{skill-name}/SKILL.md

# Check for workflows and references
ls ${AGENT_ROOT}/skills/{skill-name}/
ls ${AGENT_ROOT}/skills/{skill-name}/workflows/ 2>/dev/null
ls ${AGENT_ROOT}/skills/{skill-name}/references/ 2>/dev/null
```
