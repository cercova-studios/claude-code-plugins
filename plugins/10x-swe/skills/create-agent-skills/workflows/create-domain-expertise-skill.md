...
Explain:
```
Domain expertise skills go in: ${AGENT_ROOT}/skills/expertise/{domain-name}/
...
Location: ${AGENT_ROOT}/skills/expertise/{suggested-name}/
```
...
```bash
# Create structure
mkdir -p ${AGENT_ROOT}/skills/expertise/{domain-name}
mkdir -p ${AGENT_ROOT}/skills/expertise/{domain-name}/workflows
mkdir -p ${AGENT_ROOT}/skills/expertise/{domain-name}/references
...
# Verify structure
ls -R ${AGENT_ROOT}/skills/expertise/{domain-name}
```

## Step 11: Document in create-plans

Update `${AGENT_ROOT}/skills/create-plans/SKILL.md` to reference this new domain:
...
- [ ] Platform-specific considerations included
- [ ] Located in ${AGENT_ROOT}/skills/expertise/{domain-name}/
